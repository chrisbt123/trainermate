(function () {
  ...
  var answers = [
    { words: ["price", "cost", "full", "pro", "upgrade"], text: "TrainerMate Pro offers a £5 one-month pass with no renewal, £5 monthly until cancelled, or £40 annually until cancelled. Open Upgrade in TrainerMate and choose the clearly labelled secure Stripe option. Stripe handles the card details." },
    { words: ["cancel", "cancellation", "billing", "card", "subscription"], text: "Open Upgrade in TrainerMate and choose Manage Stripe billing. Cancelling monthly or annual renewal keeps Pro active until the period already paid for ends, then the account automatically returns to Free without deleting saved settings. A one-month pass never renews." },
